CLASS zar_cl_bp_query_provider DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
**********************************************************************
  PUBLIC SECTION.
    ...
    TYPES t_business_partner_range TYPE RANGE OF ZAR_A_BUSINESSPARTNER-BusinessPartner.
    TYPES t_business_data          TYPE TABLE OF ZAR_A_BUSINESSPARTNER.
...
CLASS ZAR_CL_BP_QUERY_PROVIDER IMPLEMENTATION.
  ...
  METHOD get_business_partners.
    ...
    service_consumption_name = to_upper( 'ZAR_SC_BUSINESS_PARTNER' ).
